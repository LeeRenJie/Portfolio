...
const bootText = [
  { id: "init",       text: "Initializing portfolio..." },
  { id: "deps",       text: "Loading dependencies... OK" },
  { id: "projects",   text: "Importing projects" },
  { id: "exp",        text: "Loading experience" },
  { id: "skills",     text: "Configuring skills" },
  { id: "blog",       text: "Fetching latest articles" },
  { id: "assets",     text: "Optimizing assets" },
  { id: "styles",     text: "Applying styles" },
  { id: "animations", text: "Setting up animations" },
  { id: "contact",    text: "Linking contact info" },
  { id: "check",      text: "Running final checks... Done" },
  { id: "ready",      text: "Everything looks good" },
  ...
  return (
    <div className="fixed inset-0 bg-black z-[9999] flex items-center justify-center p-4 cursor-pointer">
      ...
      <div className="w-full max-w-[95%] md:max-w-2xl bg-black border border-[#00f3ff]/20 rounded-lg shadow-[0_0_50px_rgba(0,243,255,0.1)] relative overflow-hidden backdrop-blur-3xl z-10">
        ...
        <div className="bg-[#111] border-b border-[#00f3ff]/10 p-3 md:p-4 flex justify-center items-center">
          <div className="flex items-center gap-2 md:gap-3">
            <div className="w-2 h-2 rounded-full bg-[#00f3ff] animate-ping"></div>
            <span className="text-[8px] md:text-[10px] text-[#00f3ff] font-black tracking-[0.2em] md:tracking-[0.4em] uppercase">Lee Ren Jie — Portfolio</span>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 w-full h-10 md:h-12 flex items-center justify-between px-4 md:px-8 bg-gradient-to-t from-black to-transparent">
          <div className="text-[7px] md:text-[8px] text-gray-700 font-bold uppercase tracking-[0.3em] md:tracking-[0.5em]">Loading...</div>
